...
public class ShippingLabel {
	...
	public static void main(String[] args) {
		ShippingLabel label = new ShippingLabel(new MailingAddress(), new MailingAddress(new FullName("Mrs.","Jane","Middle","Doe"),"880 Bay Street Province","Main Building, Room 203","Toronto","Ontario", "M7A 1A5"));
